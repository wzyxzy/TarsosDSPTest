...
class PermissionGetting {
    ...
    static void setPermissionListener(PermissionListener permissionListener, Context context, String... myPermissions) {
    ...
    static void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults, PermissionListener permissionListener) {
    ...
    static void showToAppSettingDialog() {
        AlertDialog.Builder builder = new AlertDialog.Builder(context);
        builder.setMessage("本应用需要使用权限，请到 “设置 -> 应用权限” 中授予！");
